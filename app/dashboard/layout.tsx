...
export function Sheet({children}:{children:React.ReactNode}){
  return <div style={{background:C.sheet,borderRadius:12,border:"0.5px solid rgba(5,11,20,0.035)",boxShadow:C.sheetShadow,padding:"48px 52px",maxWidth:680,position:"relative",
  ...
  return <>
    ...
    <div style={{display:"flex",height:"100vh",width:"100vw",background:C.cream,overflow:"hidden",position:"relative"}}>
      ...
      <main style={{flex:1,overflow:"auto",display:"flex",flexDirection:"column",position:"relative",zIndex:1}}>
        ...
        <div style={{flex:1,padding:"38px 44px",overflow:"auto",position:"relative",zIndex:1}}><PageTransition>{children}</PageTransition></div>
      </main>
    </div>
  </>;
}
